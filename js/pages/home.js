...
function privacyPolicy(){layout(`<section class="hero"><div class="eyebrow">LOVE CHESS</div><h1>Политика конфиденциальности</h1><p>Дата редакции: 21 сентября 2026 года.</p></section><section class="section"><article class="card"><h2>Какие данные мы обрабатываем</h2><p>Логин, криптографический хэш пароля, ник, рейтинг, статистику партий и технические данные сессии. Это необходимо для работы аккаунта, турниров и рейтинга.</p><h2>Что публикуется</h2><p>В публичном рейтинге отображаются только ник, рейтинг и игровая статистика. Пароли, e-mail, телефоны и другие контактные данные не публикуются.</p><h2>Права игрока</h2><p>Игрок может запросить исправление, скрытие публичного профиля или удаление аккаунта у организатора клуба. Полные сведения об операторе данных, сроках хранения и хостинге будут опубликованы до запуска регистрации.</p><p class="muted">Этот текст — рабочая версия. Перед публикацией организатор обязан заполнить контакты оператора, провайдера и сроки хранения в файле privacy-policy.md.</p></article></section>`,'privacy')}
